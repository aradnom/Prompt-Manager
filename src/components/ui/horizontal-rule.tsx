...
export function HorizontalRule({ className = "", animated = false, parallax = false }: HorizontalRuleProps) {
  ...
  const backgroundPosition = parallax ? `${scrollPercentage * 100}% 50%` : undefined;
