import type { OutputStyle, LLMOperation } from "./types";

/**
 * Builds the system prompt for LLM transform operations.
 * Centralizes prompt construction logic for use on both client and server.
 */
