        ...
        {isLoading ? (
          ...
          >
            <div className="standard-content accent-border-gradient">
              <div className="mb-12 space-y-4 text-md text-foreground">
                <p>
                  Prompt Manager is a powerful tool for organizing and managing your text-to-image diffusion model prompts.
                  Create reusable prompt blocks, combine them into stacks, and fine-tune your output with advanced styling options.
                </p>
                <p>
                  Whether you're working with Stable Diffusion, Flux, or other diffusion models, Prompt Manager helps you
                  maintain consistency across your generations while making it easy to experiment with variations.
                </p>
              </div>
          ...
          <StackContentProvider>
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5, delay: 0.1 }}
              className="mb-8 border-standard-dark-cyan accent-border-gradient"
            >
          ...
          >
            <div className="standard-content accent-border-gradient">
              <div className="mb-8 space-y-4 text-md text-foreground">
                <p>
                  Welcome! You don't have any prompts yet. To get started, you'll need to create some prompt blocks
                  and organize them into a prompt.
                </p>
                <p>
                  Blocks are reusable pieces of text that can be combined in different ways. Prompts let you arrange blocks in
                  a specific order to create complete prompts for your diffusion models.
                </p>
              </div>

              <div className="space-y-3">
                <h3 className="text-xl font-semibold text-cyan-light mb-4">Get Started:</h3>
                <div className="space-y-4">
                  <div>
                    <Link to="/blocks" className="text-magenta-medium hover:text-magenta-light font-semibold text-lg underline">
                      Create Blocks
                    </Link>
                    <p className="text-sm text-cyan-medium mt-1">
                      Start by creating reusable prompt blocks with your favorite subjects, styles, and modifiers.
                    </p>
                  </div>
                  <div>
                    <Link to="/prompts" className="text-magenta-medium hover:text-magenta-light font-semibold text-lg underline">
                      Build Prompts
                    </Link>
                    <p className="text-sm text-cyan-medium mt-1">
                      Combine your blocks into prompts and set one as active to start working with it here.
                    </p>
                  </div>
                </div>
              </div>
          ...
          >
            <div className="standard-content accent-border-gradient">
              <div className="mb-6 space-y-4 text-md text-foreground">
                <p>
                  You don't currently have an active prompt selected.
                </p>
              </div>
