...
export function HeroInput({
  ...
  return (
    <div
      className={`relative flex items-center border-2 border-cyan-medium rounded-lg bg-cyan-dark/50 focus-within:border-magenta-medium focus-within:shadow-lg transition-all ${className}`}
    >
      <input
        type={type}
